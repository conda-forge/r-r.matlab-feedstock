About r-r.matlab-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-r.matlab-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3463&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-r.matlab-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-r.matlab` can be installed with `conda`:
...
```
mamba install r-r.matlab
```

It is possible to list all of the versions of `r-r.matlab` available on your platform with `conda`:
...
```
mamba search r-r.matlab --channel conda-forge
```
...
mamba repoquery search r-r.matlab --channel conda-forge

# List packages depending on `r-r.matlab`:
mamba repoquery whoneeds r-r.matlab --channel conda-forge

# List dependencies of `r-r.matlab`:
mamba repoquery depends r-r.matlab --channel conda-forge
```
